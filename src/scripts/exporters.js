...
const Exporters = (function () {
  function blueprintToImprovedInitiative(blueprint) {
    ...
    return {
      ...
      Archetypes: {
        Fig: monster.getArchetypeFig().score,
        Rog: monster.getArchetypeRog().score,
        Exp: monster.getArchetypeExp().score,
        Sag: monster.getArchetypeSag().score,
        Art: monster.getArchetypeArt().score,
        Dip: monster.getArchetypeDip().score,
      },
      ...
      Senses: monster
        .getSenses()
        .filter((x) => x.type != "Perception passive")
        .map(function (x) {
          return x.type + " " + x.value;
        }),
